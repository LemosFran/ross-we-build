...
function StickyBar({ onMenu, narrow }) {
  const [on, set] = React.useState(false);
  React.useEffect(() => {
...
Object.assign(window, { DS, R, Reveal, useMedia, go, reduced, StickyBar, MobileMenu, Hero, Services, Process });
